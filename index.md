...
**Name:** Eunice Cho  
**Email:** euc003@ucsd.edu  

**Section:** B09 Hunting for Ghost Particles - Analyzing Time Series Data produced by Semiconductor Detectors
**Mentor:** Aobo Li
...
I want to experiment with transforms like FFT or wavelet methods to analyze waveforms in the frequency domain. They might capture hidden temporal patterns that aren’t visible in the raw signal and give us a different perspective on charge collection behavior.
